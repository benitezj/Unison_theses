...
\crest{\includegraphics[width=0.4\textwidth]{unison-logo.png}}
...
\supervisorrole{\large{Director:}}
\supervisor{Dr. Jos\'e Feliciano Ben\'itez Rubio}
...
%\renewcommand{\submissiontext}{Tesis para obtener el grado de: \\ \textbf{Maestr\'ia en Ciencias (F\'isica)}}
\renewcommand{\submissiontext}{A thesis submitted in partial fulfillment of the requirements for the degree of:}
\renewcommand{\degreetitle}{\textbf{Master of Science in Physics}}
