...
This is the mean value of each super separation off al the bcids
...
%\begin{figure}[H]
  %  \begin{subfigure}{0.5\textwidth}
    %\centering
    %\includegraphics[width=0.5\textwwidth]{fitqg1.png}
    %\includegraphics[width=0.5\columnwidth]{fitqg2.png}
