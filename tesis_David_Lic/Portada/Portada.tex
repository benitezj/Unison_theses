...
\begin{minipage}[c][0.17\textheight][t]{0.7\textwidth}
    \begin{center}
        ...
        {\scshape Departamento de F\'isica} %% NOMBRE DE LA DIVISIÓN
    \end{center}
\end{minipage}
%}
%
...
\begin{minipage}[c][0.78\textheight][t]{0.8\textwidth}
      \begin{center}
      \vspace{2cm}
        {\Large \scshape {Estudio del modelo de ruido para la medici\'on de luminosidad con Pixel Cluster Counting en CMS}}

        \vspace{3cm}

        \makebox[5cm][c]{\LARGE TESIS}  \\[20pt]
         en cumplimiento parcial para conseguir el grado de:\\[5pt]
        {\Large \textbf{{LICENCIADO EN FISICA}}}\\[40pt]
        Por:\\[12pt]
        \textbf{  {\large David Alonso Guzm\'an L\'opez}}
