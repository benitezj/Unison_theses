...
Fig. \ref{fig:stabprof1_79} shows the projection of the luminosity ratio using 50 lumi section binning strategy. %By grouping the lumi sections into larger bins, this visualization enables an aggregated view of luminosity data over broader intervals of the data-taking period.
