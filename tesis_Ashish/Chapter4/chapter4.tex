...
%\begin{figure}[!htp]
%\centering
%\includegraphics[width=1\textwidth]{ashish_thesis/type2res_gr0.5.png}
%\caption[]{%                                                                                                                                                                                               
...
\begin{figure}[!htp]
\centering
\includegraphics[width=1\textwidth]{ashish_thesis/type1frac_gr0p5.png}
\caption[]{%                                                                                                                                                                                              
   Type 1 residual fraction.                                                                                                                                                                              
}
\label{fig:type2}
...
\begin{tabular}{cccc}
\textbf{N/I} & \textbf{Systematic names} & \textbf{Uncertainty (PAS) [\%]} & \textbf{Uncertainty (Final veto) [\%]} \\
\hline
...
Integration & Afterglow & 0.5 & 0.3 \\
 & Cross detector stability & 0.6 & 0.24 \\
 & Linearity & 1.1 & 0.35 \\
Total & -- & 2.47 & 0.813 \\
\end{tabular}
\end{table}
