...
\caption[Background estimation]{2D histogram filled with the Avg. PCC rate evaluated per NB4, during head-on collisions (high part) and during the Super-Separation window (low part).}
