...
The PCC method is studied for its precision in luminosity measurement using 2017, 2018 and 2022  datasets. The results of these studies demonstrate that the PCC luminosity measurement method is stable and linear. %able to achieve final uncertainty on the luminosity measurement at the level of 1\% or better.
Final systematic uncertainty achieved on luminosity measurement for 2018 and 2022 datasets are 2.2\% and
 1.4\% respectively. %1\% systematic uncertainty on the final luminosity measurement.
...
Linearity of the Tracker endcap pixel (TEPX) and Disk 4 Ring 1 luminometers is expected to be within 1\% (offline) up to a pileup of 200 and their statistical precision per second is about 0.1\% at pileup 200.
