...
\begin{minipage}[c][0.78\textheight][t]{0.8\textwidth}
      \begin{center}
      \vspace{2cm}
        {\Large \scshape {Luminosity measurement with the Pixel detector at the CMS experiment of the Large Hadron Collider}
...
requirements for the degree of:\\[5pt]
        ...
        { Hermosillo, Sonora} \hskip2.5cm {June, 2023}
      \end{center}
\end{minipage}
%}
