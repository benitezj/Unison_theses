...
\begin{figure}[!htp]
  \centering
  \includegraphics[width=0.2 \columnwidth]{ashish_thesis/tepx_alllayer.png}
  \caption[TEPX double disk]{ \onehalfspacing R-Z view of the TEPX one double disk showing all four layers L1, L2, L3 and L4. Layer 1 and 3 has Ring 1, 3 and 5 modules, Layer 2 and 4 has Ring 2 and Ring 4 modules.}
