...
%To develop the upgraded luminosity measurement system for Run 3 and the HL-LHC phases.
The calibration of this luminometer allows for precise measurement of the LHC luminosity and subsequent tests of the Standard Model and searches for new physics like dark matter and supersymmetry theories.
...
\item Understand the CMS silicon pixel detector and the PCC method for luminosity measurement using this detector.

\item Process the PCC data from Run 2 (2018) for understanding the tools.

\item Process the PCC data from Run 3 (2022) to obtain the calibration constant.

\item Study the vdM Calibration method, including the fit models and systematic uncertainties.
...
\begin{itemize}
\item Determination of PCC luminometer calibration constant for the 2022 data to be collected in September 2022.
\item Estimation of the background noise for PCC during vdM calibration program.
\item Estimation of statistical and systematic uncertainties.
\end{itemize}
...
\item {\bf Summer 2022}:
  ...
  \SubItem{ Computing account and usage of the computing center CERN-lxplus}
  \SubItem{ Understanding luminosity and the methodology for the measurement}

\item {\bf Semester 2022-2}:
  \SubItem{ Elective course I on particle physics, particle detection, or data analysis}
  \SubItem{ Analysis/Computing skills (\textsc{Bash, Emacs, c/c++, python, ROOT})}
  \SubItem{ Practice analysis using Run 2 luminosity data}
  \SubItem{ Initial processing and analysis of Run 3 vdM data}

\item {\bf Semester 2023-1}:
  \SubItem{ Elective course II on particle physics, particle detection, or  data analysis}
  \SubItem{ Completion of the analysis of the LHC Run 3 vdM data and determination of the calibration constant}
