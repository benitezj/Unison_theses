...
Only modules that are found to operate consistently well for luminosity purposes during the year of the VdM scan are used in the measurement, a brief description of the procedure to the selection of these a presented in the next section.
