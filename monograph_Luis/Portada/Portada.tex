...
\begin{minipage}[c][0.78\textheight][t]{0.8\textwidth}
      \begin{center}
      \vspace{2cm}
        {\Large \scshape {Desarrollo y calibración del sistema de medición de luminosidad del detector de píxeles de silicio CMS}}

        \vspace{3cm}

        \makebox[5cm][c]{\LARGE Monograf\'ia}  \\[20pt]
         En cumplimiento parcial de los requisitos para el grado de:\\[5pt]
        {\Large \textbf{{Doctorado en Ciencias (F\'isica)}}}\\[40pt]
        By:\\[12pt]
        \textbf{  {\large Luis Enriquue Enrique CUEVAS PICOS}}
